 ...
 *
 * That matters more than it sounds. IDEF1X is erwin's default and the notation US
 * enterprise and federal data architects are trained on, and a tool that cannot draw it
 * reads as a diagramming toy no matter how good its metamodel is. The notations differ in
...
export function edgeStyleFor(
  ...
  switch (notation) {
     ...
     * are solid while non-identifying are dashed, which is how erwin draws IE too.
     */
    case "crowsFoot":
    default:
      return {
