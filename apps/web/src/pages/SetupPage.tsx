 ...
 *
 * It also answers the complaint that this tool feels unlike the ones it competes with.
 * erwin, PowerDesigner and ER/Studio all open on an explicit act of creation: name a
 * model, choose a target platform, pick a notation. That ceremony is not decoration, it
...
export function SetupPage({
   ...
   *
   * This is the step every tool in this category opens with, erwin asks for a target
   * database before it will let you draw a physical model, because the platform decides
    ...
    <div className="setup">
      <div className="setup__card">
        <header className="setup__head">
          ...
          <h1 className="setup__title">Create your model repository</h1>
          <p className="setup__lede">
            There is no model repository here yet. This creates one, a{" "}
            <code>strata.config.yaml</code> and a <code>.gitattributes</code>, and nothing else.
            Your models will be plain YAML files in it, so git gives you history, review and
            merging rather than a database nobody can diff.
          </p>
          {root ? (
